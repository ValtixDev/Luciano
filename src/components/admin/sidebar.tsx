                ...
                return (
                  <li key={item.href}>
                    <Link
                      ...
                      className={`relative block rounded-lg py-2.5 pl-4 pr-3 text-sm transition-[background-color,color] duration-200 ${
                        ativo
                          ? "bg-white/10 font-semibold text-white"
                          : "text-white/60 hover:bg-white/5 hover:text-white"
                      }`}
                    >
                      {/* Marcador dourado: diz qual seção está aberta sem
                          depender só do contraste do fundo. */}
                      <span
